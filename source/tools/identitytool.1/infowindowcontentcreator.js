...
var InfoWindowContentCreator = {
  getContent: async function (entityAttributes, layerConfig, itemTemplate) {
    var _layerConfig = $.extend(true, {}, layerConfig);
    var fields = _layerConfig.fields;
    var translationConfig = _layerConfig.translationConfig;
